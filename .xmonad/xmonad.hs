...
-- myFiles :: String
-- myFiles = myterminal ++ "ranger" -- Sets Dolphin as file browser
...
myStartupHook = do
    ...
    spawnOnce "lxsession &"
    spawnOnce "picom &"
    spawnOnce "sh ~/Pictures/styli.sh/styli.sh -s nature &"
    spawnOnce "nm-applet &"
    spawnOnce "volumeicon &"
    spawnOnce "conky -c $HOME/.config/conky/xmonad.conkyrc"
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 0 --transparent true --alpha 0 --tint 0x282c34  --height 40 &"
...
myWorkspaces = [" dev ", " www ", " sys ", " doc ", " win10 ", " chat ", " mus ", " vid ", " gfx "]
...
myManageHook = composeAll
     ...
     , className =? "looking-glass-client"--> doShift ( myWorkspaces !! 4 )
...
myKeys =
    ...
    -- KB_GROUP Kill windows
        , ("M-S-w", kill1)     -- Kill the currently focused client
        , ("M-S-w-a", killAll)   -- Kill all windows on current workspace
    ...
    -- KB_GROUP Grid Select (CTR-g followed by a key)
        ...
        , ("C-g b", bringSelected $ mygridConfig myColorizer) -- bring selected window @si
   ...
   -- xmproc2 <- spawnPipe "xmobar -x 2 $HOME/.config/xmobar/xmobarrc2"
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
           ...
           { ppOutput =   
                       \x -> hPutStrLn xmproc0 x                          -- xmobar on monitor 1
