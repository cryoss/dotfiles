...
(doom! :input
       ...
       (spell +flyspell +flyspell +everywhere) ; tasing you for misspelling mispelling
       ...
       (org +pretty +journal +pandoc +roam2 +present +hugo +brain +dragndrop +gunplot +jupyter)               ; organize your plain life in plain text
